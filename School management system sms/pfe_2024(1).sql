...
--
-- Hôte : 127.0.0.1
-- Généré le : mar. 07 mai 2024 à 12:18
...
--
-- Déchargement des données de la table `absenceetudiant`
--
...
--
-- Déchargement des données de la table `classegenerique`
--
...
--
-- Déchargement des données de la table `docjustifabsetudiant`
--
...
--
-- Déchargement des données de la table `seancegenerique`
--
...
--
-- Index pour la table `absenceetudiant`
--
...
--
-- Index pour la table `classegenerique`
--
...
--
-- Index pour la table `docjustifabsetudiant`
--
...
--
-- Index pour la table `seancegenerique`
--
...
--
-- AUTO_INCREMENT pour la table `absenceetudiant`
--
ALTER TABLE `absenceetudiant`
...
--
-- AUTO_INCREMENT pour la table `classegenerique`
--
ALTER TABLE `classegenerique`
...
--
-- AUTO_INCREMENT pour la table `docjustifabsetudiant`
--
ALTER TABLE `docjustifabsetudiant`
...
--
ALTER TABLE `etudiant`
  MODIFY `id_etudiant` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=159;
...
--
-- AUTO_INCREMENT pour la table `seancegenerique`
--
ALTER TABLE `seancegenerique`
...
--
ALTER TABLE `user`
  MODIFY `id_user` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=169;
